    ...
    <div class="container">
        ...
        <div class="header-right">
            <div class="social-icons social-icons-color">
                ...
                ?>
                <a href="<?php echo $whatsapp; ?>" class="social-icon social-facebook" title="واتسپ" target="_blank"><i
                            class="icon-whatsapp"></i></a>
                <a href="<?php echo $telegram; ?>" class="social-icon social-twitter" title="تلگرام" target="_blank"><i
                            class="icon-telegram"></i></a>
                <a href="<?php echo $instagram ; ?>" class=icon-instagram" title="اینستاگرام" target="_blank"><i
    ...
    <div class="container">
        ...
        <div class="header-center">
            ...
            <a href="<?php echo  home_url(); ?>" class="logo">
                ...
                <?php else : ?>
                    <img src="<?php echo  TNM_URL .  '/assets/images/demos/demo-25/logo.png'?>" alt="<?php echo  bloginfo('name'); ?>" width="82" height="20">
                <?php endif; ?>
            </a>
        </div><!-- End .header-left -->
        <div class="header-right">
