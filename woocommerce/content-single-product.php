...
<?php endif; ?>
                                ...
                                <div class="product-details-footer">
                                    ...
                                    $product_img   = urlencode( wp_get_attachment_url( $product->get_image_id() ) );
                                    ?>
                                    ...
                                    <div class="social-icons social-icons-sm">
                                        ...
                                        <!-- Facebook -->
                                        <a class="social-icons-2"
                                           href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $product_url; ?>"
                                           target="_blank"
                                        ...
                                        <!-- Twitter / X -->
                                        <a class="social-icons-2"
                                           href="https://twitter.com/intent/tweet?text=<?php echo $product_title; ?>&url=<?php echo $product_url; ?>"
                                           target="_blank"
                                           rel="noopener noreferrer"
                                        ...
                                        <!-- Instagram (محدودیت دارد) -->
                                        <a class="social-icons-2"
                                           href="<?php echo esc_url( $product_url ); ?>"
                                           onclick="navigator.clipboard.writeText(this.href); alert('لینک محصول کپی شد'); return false;"
                                        ...
                                        <!-- Telegram -->
                                        <a class="social-icons-2"
                                           href="https://t.me/share/url?url=<?php echo $product_url; ?>&text=<?php echo $product_title; ?>"
                                           target="_blank"
                                           rel="noopener noreferrer"
                                        ...
                                        <!-- WhatsApp -->
                                        <a class="social-icons-2"
                                           href="https://api.whatsapp.com/send?text=<?php echo $product_title . '%20' . $product_url; ?>"
                                           target="_blank"
                                           rel="noopener noreferrer"
